...
<html lang="en">
	<head>
		<title>Cancelled Salary Payments => <?php echo $sys_comp_name; ?></title>
	...
	<body class="app sidebar-mini">
		...
		<main class="app-content">
			<div class="app-title">
				<div>
					<h4><i class="fa fa-times-rectangle fa-lg"></i> CANCELLED SALARY PAYMENTS</h4>
					<p>Cancelled Salary Payments List Page</p>
				</div>
				<ul class="app-breadcrumb breadcrumb">
					<li class="breadcrumb-item"><i class="fa fa-home"></i></li>
					<li class="breadcrumb-item"><a href="cancelled-salary-payments">Cancelled Salary Payments</a></li>
				</ul>
			</div>
					...
					<div class="tile">
						<div class="tile-body">
							<div class="table-responsive">
								<table class="table table-striped table-bordered table-sm tableRestyle" id="cancelledSalaryPaymentsTable">
									<thead>
										<tr align="center">
											<th>Ser_No</th>
											<th>Employee Name</th>
									...
									<tbody>
										...
										<?php
											$cancelledSalaryPaymentsList = mysqli_query($conn, "SELECT charge_pay_salaries.rowNo, employees.empName, charge_pay_salaries.salaryMonth, charge_pay_salaries.paidAmount, charge_pay_salaries.registerDate, users.userName FROM charge_pay_salaries JOIN employees ON (charge_pay_salaries.empID = employees.empID AND charge_pay_salaries.transactionType = '1'  AND charge_pay_salaries.transactionStatus = '0' AND employees.titlePosition <> '0') JOIN users ON (charge_pay_salaries.cancelledBy = users.userID) ORDER BY charge_pay_salaries.rowNo DESC");
											$c = 1;
											while ($result = mysqli_fetch_array($cancelledSalaryPaymentsList)) {
												?>
													<tr>
		...
		<script type="text/javascript"> $("#cancelledSalaryPaymentsTable").DataTable({"pageLength": 100});</script>
