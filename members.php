...
<body class="app sidebar-mini">
    ...
    <main class="app-content">
        <div class="app-title">
            <div>
                <h4><i class="fa fa-users fa-lg"></i> MEMBERS</h4>
                <p>Members List Page</p>
            </div>
                    ...
                    <div class="tile-body">
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered table-sm" id="membersTable">
                                ...
                                <tbody>
                                    <?php
                                    $getMembersList = mysqli_query($conn, "SELECT members.memberID, members.memberPhoto, members.memberName, contribution_types.contributionAmount, members.memberTelephone, members.memberEmail, members.registerDate, members.memberStatus FROM members JOIN contribution_types ON (members.contributionTypeID = contribution_types.contributionTypeID) ORDER BY members.memberName") or die(mysqli_error($conn));
                                    $x = 1;
    ...
    <script type="text/javascript">
        $('#membersTable').DataTable({"pageLength": 100})
        $("#cmbMembersSex, #cmbMembersMaritalStatus, #cmbMembersJobStatus, #cmbMembersProfessionalExperience, #cmbMembersMemberStatus, #cmbMembersMemberContributionType").select2({tags: false, dropdownParent: $("#registerMemberModal")})
        $("#cmbMembersSexUp, #cmbMembersMaritalStatusUp, #cmbMembersJobStatusUp, #cmbMembersProfessionalExperienceUp, #cmbMembersMemberStatusUp, #cmbMembersMemberContributionTypeUp").select2({tags: false, dropdownParent: $("#updateMemberModal")})
    </script>
